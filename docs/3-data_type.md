...
Se representan con un `NA`, para cualquier tipo de tipo de datos
...
::: {#box1 .blue-box}
-   Pero nosostros comunmente usamos 'dd/mm/yyyy'? debemos convertir
...
En R las variables categóricas se almacenan como **factores** tanto sea para vectores que contienen caracteres o numéricos Uno de los usos más importantes de los factores es en el modelado estadístico, dado que éstos tendran un efecto diferente a las variables contínuas. Claro ejemplo de factores son los tratamientos, por ej: fungicidas, genotipos, bloques, etc.
